...
export const techCatalog = defineTechCatalog({
  ...
  'angular-ssr': {
    ...
    description: "Angular's SSR library for hybrid and server side rendering.",
  },
  astro: {
    label: 'Astro',
    category: 'framework',
  ...
  bun: {
    ...
    description:
      'Fast all-in-one JavaScript runtime, package manager, and bundler for modern applications.',
  },
  jquery: {
    label: 'jQuery',
    category: 'library',
  ...
  'aws-cognito': {
    ...
    description: 'User identity and access management service for applications.',
  },
  'aws-ecr': {
    label: 'ECR',
    category: 'service',
    ...
    description: 'Elastic Container Registry for managing Docker container images.',
  },
  azure: {
  ...
  flyway: {
    ...
    description: 'Database migration tool for version control of database schemas.',
  },
  ...
  dotnet: {
    // Yeah, I know... Not a language, but recruiters.
    label: 'C#/.NET',
    category: 'language',
    parent: 'languages',
