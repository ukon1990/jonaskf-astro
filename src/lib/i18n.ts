  ...
  no: {
    ...
    home: {
      ...
      intro: [
        ...
        'Fokusområdet er moderne webapplikasjoner, fra interaktive frontend-løsninger i Angular og React til robuste backend-tjenester med Spring Boot, Kotlin og TypeScript.',
    ...
    cv: {
      ...
      pdfTitle: 'Last ned CV',
      pdfDescription: 'Velg språk, forhåndsvis PDF-en og last den ned.',
      pdfLocaleLabel: 'Språk',
      pdfPreviewLabel: 'Forhåndsvisning av CV (PDF)',
      pdfDownloadLabel: 'Last ned CV (PDF)',
      present: 'nå',
      other: 'Annet',
    },
    redirect: {
  ...
  en: {
    ...
    home: {
      ...
      intro: [
        ...
        'The main focus is modern web applications, from interactive front ends in Angular and React to robust backend services with Spring Boot, Kotlin and TypeScript.',
    ...
    cv: {
      ...
      pdfTitle: 'Download CV',
      pdfDescription: 'Choose language, preview the PDF, and download it.',
      pdfLocaleLabel: 'Language',
      pdfPreviewLabel: 'CV PDF preview',
      pdfDownloadLabel: 'Download CV (PDF)',
      present: 'Present',
      other: 'Other',
    },
    redirect: {
...
export function formatPeriod(start: Date, end: Date | null | undefined, locale: Locale): string {
